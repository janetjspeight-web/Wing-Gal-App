...
function Ico({ name, size = 20, color = "currentColor", fill = "none", style }) {
  const P = {
    ...
    instagram: <><rect x="3" y="3" width="18" height="18" rx="5" /><circle cx="12" cy="12" r="3.7" /><circle cx="17.3" cy="6.7" r="0.6" fill="currentColor" stroke="none" /></>,
    tiktok: <path d="M14 4v10.5a3.5 3.5 0 1 1-2.4-3.32V4h2.4ZM14 4a4.2 4.2 0 0 0 4 4" />,
  };
  return (
